...
from qgis_gui_utils import select_item_from_gui_list, get_bbox_from_current_canvas, select_layer_from_available_layers, select_feature_from_layer_database
...
if __name__ == "__main__":
    ...
    points_layer = select_layer_from_available_layers(title="Select Points Layer", prompt="Choose the layer that contains the corner points:")
    ...
    parcel_layer = select_layer_from_available_layers(title="Select a Parcel Layer", prompt="Choose the parcel layer to analyze:")
