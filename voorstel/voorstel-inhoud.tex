...
\textcolor{purple}{
Deze bachelorproef gaat zich focussen op het ontwikkelen van een tool die GIS-datasets combineert met gebruikersgedefinieerde criteria en beperkingen ter ondersteuning van visuele site-selectie voor duurzame energievoorziening ter ondersteuning van een bidding voor de Einstein Telescope.}
