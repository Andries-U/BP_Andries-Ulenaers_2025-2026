...
\textcolor{purple}{Deze bachelorproef gaat zich focussen op het ontwikkelen van een tool die GIS-datasets combineert met gebruikersgedefinieerde criteria en beperkingen ter ondersteuning van de site-selectie voor duurzame energievoorziening ter ondersteuning van de bidding voor de Einstein Telescope locatie Euregio Maas Rijn.}
...
\textcolor{purple}{\textbf{Hoe kan een tool ontwikkeld worden die GIS datasets combineert met gebruikersgedefinieerde criteria voor site-selectie van duurzame energievoorziening voor de Einstein Telescope?}}
...
\textcolor{purple}{\begin{itemize}
    ...
    \item Hoe kunnen gebruikersgedefinieerde criteria toegepast worden deze te combineren met GIS-datasets?
    ...
    \item Welke methodes zijn geschikt om de analyse toegankelijk en interpreteerbaar te maken voor niet-\-technische stakeholders?
\end{itemize}}
...
\begin{enumerate}
    \item \textbf{Een proof-\-of-\-concept tool}: Een werkende applicatie die geografische datasets kan combineren. Hierbij moet de gebruiker ook de mogelijkheid hebben om gebruikersgedefinieerde criteria toe te voegen. De tool moet een duidelijke documentatie hebben.
...
\textbf{Onderzoekstechniek:}
\begin{itemize}
    %% :TODO: literatuurstudie is het verkeerde woord
    \item \textbf{Overzicht} van bestaande visualisatietechnieken en bepalen welke technieken het beste passen voor de site selectie.
