...
\textcolor{purple}{\textbf{Hoe kan een tool ontwikkeld worden die GIS-datasets combineert met gebruikersgedefinieerde criteria voor visuele site-selectie van duurzame energievoorziening voor de Einstein Telescope?}}
...
\textcolor{purple}{\begin{itemize}
    ...
    \item Welke geografische, ecologische en infrastructurele beperkingen en opportuniteiten zijn van toepassing in de Euregio Maas-\-Rijn voor energie-\-infrastructuur?
...
\textcolor{purple}{\begin{itemize}
    \item Welke van de geidentificeerde bestaande tools geven de beste mogelijkheid om uit te breiden voor de specifieke doeleinden van de ET-onderzoeksgroep?
