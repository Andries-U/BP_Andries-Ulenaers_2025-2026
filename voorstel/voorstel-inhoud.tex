...
Deze bachelorproef gaat zich focussen op het ontwikkelen van een tool die bestaande GIS-\-datasets gebruikt en harmoniseert alsook de mogelijkheid geeft om bepaalde geografische gebieden te prioritariseren omwille van maatschappelijke of praktische factoren.

% Doelgroep
Deze bachelorproef richt zich op de ET-onderzoeksgroep en specifiek op de energie- en infrastructuurplanners die verantwoordelijk zijn voor het ontwerpen van een haalbare, duurzame energievoorziening voor de faciliteit. Secundair kunnen de resultaten ook relevant zijn voor andere grootschalige grensoverschrijdende infrastructuurprojecten die te maken hebben met complexe geografische constraints en multi-nationale data-integratie.
...
\textbf{Hoe kan een tool ontwikkeld worden die GIS-datasets combineert met gebruikersgedefinieerde criteria voor visuele site-selectie bij duurzame energievoorziening van grote infrastructuurprojecten?}
...
\subsubsection{Stap 1: Vereistenanalyse}
\textbf{Doel:}
...
\subsubsection{Stap 2: Vergelijkende Studie van Bestaande Tools}
\textbf{Doel:}
...
\subsubsection{Stap 3: Ontwikkeling en Uitbreiding van de Tool}
\textbf{Doel:}
...
\subsubsection{Stap 4: Visualisatie en Validatie}
\textbf{Doel:}
...
\subsubsection{Stap 5: Risicoanalyse}
\textbf{Doel:}
