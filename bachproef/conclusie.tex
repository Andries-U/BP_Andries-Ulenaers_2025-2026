...
Deze bachelorproef heeft zich gericht op de ontwikkeling van een \acrfull{gis}-gebaseerde tool ter ondersteuning van de energieanalyse voor de \acrfull{et}-kandidaat locatie in de \acrfull{emr}. Het analyseren van grensoverschrijdende datasets uit verschillende bronnen, met uiteenlopende formaten en kwaliteit, vormt hierbij een uitdaging. Deze uitdaging wordt vergroot door de nood om snel meerdere opties voor energiewinning te analyseren.\bigskip
...
Samenvattend toont deze thesis aan dat een \acrshort{gis}-gebaseerde analysetool een waardevolle bijdrage kan leveren aan het energieplanningsproces van de \acrshort{et}. Toekomstig onderzoek kan zich richten op het integreren van geavanceerde analysemethoden, zoals \acrfull{mcda} en energieproductiemodellen, om de tool verder te versterken en te verfijnen.
