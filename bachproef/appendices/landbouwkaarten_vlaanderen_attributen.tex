...

{
    ...
    \begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}l >{\raggedright\arraybackslash}X @{}}
        \caption{Beschrijving van de attributen in de dataset `landbouwgebruikspercelen' \autocite{vlaanderen_landbouwpercelen_2025}}\label{app:ontwikkelingTool_landbouwkaart-vlaanderen-attributen} \\
